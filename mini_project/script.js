...
function feedback(){
  ...
  if(name.value && email.value && custmor_feedback.value){
    console.log('working');
...
function dislike(){
  document.getElementById('popup1').style.display='none';
  setTimeout("document.getElementById('popup3').style.display='block'",delay_popup);
}
function userInfo(){
  document.getElementById('popup2').style.display='none';
  document.getElementById('popup3').style.display='none';
  setTimeout("document.getElementById('popup4').style.display='block'",delay_popup);
}
function removeall(){
  feedback()
  //document.getElementById('popup4').style.display='none';
